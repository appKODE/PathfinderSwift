...
final class ServerTypeView: UIView {
    typealias EnvironmentTypeSelectionHandler = (PathfinderEnvironment) -> Void

    // Handlers
    var onSelected: EnvironmentTypeSelectionHandler?

    // Properties
    public var envType: PathfinderEnvironment?
    ...
    convenience init(as type: PathfinderEnvironment, isSelected: Bool) {
        self.init()
        self.envType = type
