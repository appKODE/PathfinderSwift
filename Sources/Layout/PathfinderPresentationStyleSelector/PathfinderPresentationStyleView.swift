...
final class PathfinderPresentationStyleView: UIView {
    typealias PresentationStyleTappedHandler = (PathfinderQueriesPresentationStyle) -> Void

    // Handlers
    var onStyleSelected: PresentationStyleTappedHandler?

    // Properties
    public var presentationStyle: PathfinderQueriesPresentationStyle?
    ...
    // Lifecycle
    convenience init(as style: PathfinderQueriesPresentationStyle, isSelected: Bool) {
        self.init()
