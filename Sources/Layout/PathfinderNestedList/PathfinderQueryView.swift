...
final class PathfinderQueryView: UIView {

    // Handlers
    var onTap: PathfinderNestedListView.QuerySelectionHandler?
    ...
    static func makeMethodView(_ method: PathfinderHttpMethod) -> UIView {
