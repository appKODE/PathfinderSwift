...
final class QueryEditorController: UIViewController {
    ...
    private func setupViews() {
        ...
        let httpMethodView = PathfinderQueryView.makeMethodView(config.httpMethod)
    ...
    override public func viewWillDisappear(_ animated: Bool) {
        ...
        vStack.arrangedSubviews.forEach { subview in
            if let editorView = subview as? PathfinderQueryEditorField,
    ...
    private func fillVStack() {
        ...
        params.forEach { param in
            ...
            let editorField = PathfinderQueryEditorField(paramName: param, value: value)
